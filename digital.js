...
function background(time){
     if(time >= 0 && time < 12){
        document.body.style.background = "url(img/manha.jpg) no-repeat center/100% 100% ";
 } else if (time >= 12 && time < 18){
    document.body.style.background = "url(img/tarde.jpg) no-repeat center/100% 100% ";
 }else{
    document.body.style.background = "url(img/noite.jpg) no-repeat center/100% 100% ";
 }
}
